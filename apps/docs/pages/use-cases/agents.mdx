...
* Note: The `alias` and `avatar` fields are the ENS equivalent of the `name` and `image` fields in an ERC-8004 registration file. ERC-8004 field names are inspired by NFT metadata, whereas ENS field names are designed more for identity and profiles (ENSIP-5 and ENSIP-18).
