...
Verification is purely local: one `ecrecover` against the envelope signature, compared to the current resolution of the attester's ENS name. No attester call required at verify time.

## Step 1: Create the attestation

1. Open the attestations app and connect the wallet that controls the ENS name you want to attest.
