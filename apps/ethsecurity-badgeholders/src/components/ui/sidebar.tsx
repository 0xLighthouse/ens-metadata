    ...
    return (
      <main
        ...
        className={cn(
          ...
          'peer-data-[variant=inset]:min-h-[calc(100svh-(var(--spacing-4)))] md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow',
          className,
        )}
        {...props}
      />
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={sidebarMenuButtonVariants({ variant, size, class: className })}
        {...props}
      />
    )
